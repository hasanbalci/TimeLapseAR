    ...
    public class basestat
    {
        ...
        *************************************************************************/
        public static void _pexec_covm(double[,] x,
            ...
            ref double[,] c)
        {
            alglib.smp.ae_task_info _task = alglib.smp.ae_create_task(null);
            try
            {
                _task.data.func = _root_covm;
                _task.data.parameters[0].val = x;
                _task.data.parameters[1].ival = n;
                _task.data.parameters[2].ival = m;
                _task.data.parameters[3].val = c;
                alglib.smp.ae_push_root_task(_task);
                alglib.smp.ae_wait_for_event(_task.done_event);
                c = (double[,])_task.data.parameters[3].val;
            }
            finally
            {
                System.Exception _e = _task.exception;
                alglib.smp.ae_dispose_task(_task);
                if( _e!=null )
                    throw _e;
            }
        }
        ...
        *************************************************************************/
        public static void _root_covm(alglib.smp.ae_task_data _data)
        {
            double[,] x = (double[,])_data.parameters[0].val;
            int n = _data.parameters[1].ival;
            int m = _data.parameters[2].ival;
            double[,] c = (double[,])_data.parameters[3].val;
            covm(x,n,m,ref c);
            _data.parameters[3].val = c;
        }
        ...
        *************************************************************************/
        ...
        This method is called when worker thread starts working on root task.
        *************************************************************************/
        public static void _root_pearsoncorrm(alglib.smp.ae_task_data _data)
        {
            double[,] x = (double[,])_data.parameters[0].val;
            int n = _data.parameters[1].ival;
            int m = _data.parameters[2].ival;
        ...
        *************************************************************************/
        ...
        This method is called when worker thread starts working on root task.
        *************************************************************************/
        public static void _root_spearmancorrm(alglib.smp.ae_task_data _data)
        {
            double[,] x = (double[,])_data.parameters[0].val;
            int n = _data.parameters[1].ival;
            int m = _data.parameters[2].ival;
        ...
        *************************************************************************/
            ...
            ref double[,] c)
        {
            ...
            try
            {
                ...
                _task.data.parameters[0].val = x;
                _task.data.parameters[1].val = y;
                _task.data.parameters[2].ival = n;
                _task.data.parameters[3].ival = m1;
                _task.data.parameters[4].ival = m2;
                _task.data.parameters[5].val = c;
                alglib.smp.ae_push_root_task(_task);
                alglib.smp.ae_wait_for_event(_task.done_event);
                c = (double[,])_task.data.parameters[5].val;
            }
            finally
            {
                System.Exception _e = _task.exception;
        ...
        This method is called when worker thread starts working on root task.
        *************************************************************************/
        public static void _root_covm2(alglib.smp.ae_task_data _data)
        {
            double[,] x = (double[,])_data.parameters[0].val;
            double[,] y = (double[,])_data.parameters[1].val;
            int n = _data.parameters[2].ival;
            int m1 = _data.parameters[3].ival;
            int m2 = _data.parameters[4].ival;
            double[,] c = (double[,])_data.parameters[5].val;
            covm2(x,y,n,m1,m2,ref c);
            _data.parameters[5].val = c;
        }
        ...
        *************************************************************************/
        ...
        This method is called when worker thread starts working on root task.
        *************************************************************************/
        public static void _root_pearsoncorrm2(alglib.smp.ae_task_data _data)
        {
            double[,] x = (double[,])_data.parameters[0].val;
            double[,] y = (double[,])_data.parameters[1].val;
            int n = _data.parameters[2].ival;
        ...
        *************************************************************************/
            ...
            ref double[,] c)
        {
            ...
            alglib.smp.ae_task_group _child_tasks = null;
            bool _smp_enabled = false;
            c = new double[0,0];
            ...
            if( n<=1 )
            {
                ...
                alglib.smp.ae_sync(_child_tasks, _smp_enabled, true);
                return;
            }
            ...
            alglib.smp.ae_set_smp_support(ref _child_tasks, ref _smp_enabled, true);
            _spawn_rankdata(xc, m1, n, _child_tasks, _smp_enabled);
            rankdata(yc, m2, n);
            alglib.smp.ae_sync(_child_tasks, _smp_enabled, false);
        ...
        *************************************************************************/
        ...
        This method is called when worker thread starts working on root task.
        *************************************************************************/
        public static void _root_spearmancorrm2(alglib.smp.ae_task_data _data)
        {
            double[,] x = (double[,])_data.parameters[0].val;
            double[,] y = (double[,])_data.parameters[1].val;
            int n = _data.parameters[2].ival;
        ...
        *************************************************************************/
            ...
            int nfeatures)
        {
            ...
            try
            {
                ...
                _task.data.parameters[0].val = xy;
                _task.data.parameters[1].ival = npoints;
                _task.data.parameters[2].ival = nfeatures;
                alglib.smp.ae_push_root_task(_task);
                alglib.smp.ae_wait_for_event(_task.done_event);
            }
            finally
        ...
        This method is called when worker thread starts working on root task.
        *************************************************************************/
        public static void _root_rankdata(alglib.smp.ae_task_data _data)
        {
            double[,] xy = (double[,])_data.parameters[0].val;
            int npoints = _data.parameters[1].ival;
            int nfeatures = _data.parameters[2].ival;
        ...
        Executed serially when called with _group==null or smp_enabled==false.
        *************************************************************************/
        public static void _spawn_rankdata(double[,] xy,
            int npoints,
            int nfeatures,
            alglib.smp.ae_task_group _group, bool smp_enabled)
        {
            ...
            alglib.smp.ae_task_info _task = alglib.smp.ae_create_task(_group);
            _task.data.func = _task_rankdata;
            _task.data.parameters[0].val = xy;
            _task.data.parameters[1].ival = npoints;
            _task.data.parameters[2].ival = nfeatures;
            alglib.smp.ae_push_task(_task, false);
        }
        ...
        *************************************************************************/
        public static void _task_rankdata(alglib.smp.ae_task_data _data)
        {
            double[,] xy = (double[,])_data.parameters[0].val;
            int npoints = _data.parameters[1].ival;
            int nfeatures = _data.parameters[2].ival;
        ...
        *************************************************************************/
        ...
        This method is called when worker thread starts working on root task.
        *************************************************************************/
        public static void _root_rankdatacentered(alglib.smp.ae_task_data _data)
        {
            double[,] xy = (double[,])_data.parameters[0].val;
            int npoints = _data.parameters[1].ival;
            int nfeatures = _data.parameters[2].ival;
        ...
        Executed serially when called with _group==null or smp_enabled==false.
        *************************************************************************/
        public static void _spawn_rankdatacentered(double[,] xy,
            int npoints,
            int nfeatures,
            alglib.smp.ae_task_group _group, bool smp_enabled)
        {
        ...
        This method is called when worker thread starts working on a non-root task.
        *************************************************************************/
        public static void _task_rankdatacentered(alglib.smp.ae_task_data _data)
        {
            double[,] xy = (double[,])_data.parameters[0].val;
            int npoints = _data.parameters[1].ival;
            int nfeatures = _data.parameters[2].ival;
        ...
        *************************************************************************/
            ...
            int basecasecost)
        {
            ...
            if( i1-i0>=2 && (double)(problemcost)>(double)(basecasecost) )
            {
                alglib.smp.ae_set_smp_support(ref _child_tasks, ref _smp_enabled, true);
                im = (i1+i0)/2;
                _spawn_rankdatarec(xy, i0, im, nfeatures, iscentered, pool, basecasecost, _child_tasks, _smp_enabled);
        ...
        Executed serially when called with _group==null or smp_enabled==false.
        *************************************************************************/
        public static void _spawn_rankdatarec(double[,] xy,
            int i0,
            int i1,
            int nfeatures,
            bool iscentered,
            ...
            alglib.smp.ae_task_group _group, bool smp_enabled)
        {
            if( _group==null || !smp_enabled)
            {
                rankdatarec(xy,i0,i1,nfeatures,iscentered,pool,basecasecost);
                return;
            }
            alglib.smp.ae_task_info _task = alglib.smp.ae_create_task(_group);
            _task.data.func = _task_rankdatarec;
            _task.data.parameters[0].val = xy;
            _task.data.parameters[1].ival = i0;
            _task.data.parameters[2].ival = i1;
            _task.data.parameters[3].ival = nfeatures;
            _task.data.parameters[4].bval = iscentered;
            _task.data.parameters[5].val = pool;
            _task.data.parameters[6].ival = basecasecost;
            alglib.smp.ae_push_task(_task, false);
        }
        ...
        This method is called when worker thread starts working on a non-root task.
        *************************************************************************/
        public static void _task_rankdatarec(alglib.smp.ae_task_data _data)
        {
            double[,] xy = (double[,])_data.parameters[0].val;
            int i0 = _data.parameters[1].ival;
            int i1 = _data.parameters[2].ival;
            int nfeatures = _data.parameters[3].ival;
            bool iscentered = _data.parameters[4].bval;
            alglib.smp.shared_pool pool = (alglib.smp.shared_pool)_data.parameters[5].val;
            int basecasecost = _data.parameters[6].ival;
           rankdatarec(xy,i0,i1,nfeatures,iscentered,pool,basecasecost);
        }
        ...
        Executed serially when called with _group==null or smp_enabled==false.
        *************************************************************************/
        public static void _spawn_rankdatabasecase(double[,] xy,
            int i0,
            int i1,
            int nfeatures,
            bool iscentered,
            ...
            alglib.smp.ae_task_group _group, bool smp_enabled)
        {
            ...
            alglib.smp.ae_task_info _task = alglib.smp.ae_create_task(_group);
            _task.data.func = _task_rankdatabasecase;
            _task.data.parameters[0].val = xy;
            _task.data.parameters[1].ival = i0;
            _task.data.parameters[2].ival = i1;
            _task.data.parameters[3].ival = nfeatures;
            _task.data.parameters[4].bval = iscentered;
            _task.data.parameters[5].val = buf0;
            _task.data.parameters[6].val = buf1;
            alglib.smp.ae_push_task(_task, false);
        }
        ...
        This method is called when worker thread starts working on a non-root task.
        *************************************************************************/
        public static void _task_rankdatabasecase(alglib.smp.ae_task_data _data)
        {
            double[,] xy = (double[,])_data.parameters[0].val;
            int i0 = _data.parameters[1].ival;
            int i1 = _data.parameters[2].ival;
            int nfeatures = _data.parameters[3].ival;
            bool iscentered = _data.parameters[4].bval;
            apserv.apbuffers buf0 = (apserv.apbuffers)_data.parameters[5].val;
            apserv.apbuffers buf1 = (apserv.apbuffers)_data.parameters[6].val;
           rankdatabasecase(xy,i0,i1,nfeatures,iscentered,buf0,buf1);
        }
